...
exports.createOrganization = async (req, res) => {
  ...
  await sequelize.query(
    `INSERT INTO userHistory_${userId}(organizationNumber) VALUES(?)`,
    {
  ...
  await sequelize.query(
    `CREATE TABLE IF NOT EXISTS payment_${OrganizationNumber}(
        id INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
        amount REAL ,
  ...
  await sequelize.query(
    `INSERT INTO organization_${OrganizationNumber}(name,address,vatNo,userId) VALUES(?,?,?,?)`,
    {
      type: QueryTypes.INSERT,
...
exports.createPayment = async (req, res) => {
  ...
  await sequelize.query(
    `INSERT INTO payment_${organizationNumber}(partyName,amount) VALUES(?,?)`,
    {
      type: QueryTypes.INSERT,
